...
def get_conditions(filters):
	...
	if filters.get("item_group"):
		groups = get_child_item_groups(filters.get("item_group"))
		group_conditions = """and ifnull(`tabPurchase Invoice Item`.item_group, '') in (%s) """ % ", ".join(['"%s"']*len(groups))
		group_conditions = group_conditions % tuple(groups)
