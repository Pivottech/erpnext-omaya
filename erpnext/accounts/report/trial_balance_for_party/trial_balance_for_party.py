...
def get_data(filters, show_party_name):
	...
	for party in parties:
		...
		has_value = False
		if (opening_debit or opening_credit or debit or credit or closing_credit or closing_debit):
			has_value  =True
		has_closing_value = False
		if closing_credit or closing_debit: 
			has_closing_value = True
		
		if cint(filters.show_zero_closing_values) or has_closing_value:
			data.append(row)
...
def get_columns(filters, show_party_name):
	...
	if filters.show_opening:
		columns += opening_columns
	if filters.show_period_balance:
