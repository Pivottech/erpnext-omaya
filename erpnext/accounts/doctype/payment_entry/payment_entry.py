...
class PaymentEntry(AccountsController):
	...
	def validate_reference_documents(self):
		if self.party_type == "Student":
			...
			valid_reference_doctypes = ("Sales Order", "Sales Invoice", "Journal Entry", "Dunning", "Service Invoice")
...
def get_reference_details(reference_doctype, reference_name, party_account_currency):
	...
	if reference_doctype in ("Fees", "Service Invoice") :
...
def get_payment_entry(dt, dn, party_amount=None, bank_account=None, bank_amount=None):
	...
	paid_amount, received_amount = set_paid_amount_and_received_amount(
		dt, party_account_currency, bank, outstanding_amount, payment_type, bank_amount, doc) if dt != "Service Invoice" else (doc.paid_amount , doc.paid_amount)
...
def set_party_type(dt):
	if dt in ("Sales Invoice", "Sales Order", "Dunning", "Service Invoice"):
		party_type = "Customer"
...
def set_payment_type(dt, doc):
	if (dt in ("Sales Order", "Donation") or (dt in ("Sales Invoice", "Fees", "Dunning", "Service Invoice") and doc.outstanding_amount > 0)) \
