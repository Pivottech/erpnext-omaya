...
from erpnext.stock.report.item_prices.item_prices import get_last_purchase_rate
...
def get_item_price_qty_data(filters):
	...
	last_purcahses = get_last_purchase_rate()
	result = []
	if item_results:
		for item_dict in item_results:
			data = {
				...
				'selling_price_list': "",
				'selling_rate': 0.0,
				'last_buying_rate': last_purcahses.get(item_dict.item_code)
			}
