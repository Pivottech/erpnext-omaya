...
class StockEntry(StockController):
	...
	def get_item_details(self, args=None, for_update=False):
		...
		if self.purpose == 'Material Issue':
			ret["expense_account"] = (frappe.db.get_value("Warehouse", args.get("s_warehouse"), "expense_account") or
...
def get_warehouse_details(args):
	...
	ret = {}
	if args.warehouse:
		expense_account = frappe.db.get_value("Warehouse", args.warehouse, "expense_account")
		if expense_account:
			ret.update({"expense_account": expense_account})
