...
var schedule_inpatient = function(frm) {
	var dialog = new frappe.ui.Dialog({
		...
		fields: [
			...
			{fieldtype: 'Link', label: 'Service Unit', fieldname: 'service_unit', options: "Healthcare Service Unit", get_query: function () {
				return {
					filters: {
						'is_group': 0,
		...
		primary_action : function() {
			var args = {
				...
				admission_service_unit: dialog.get_value('service_unit'),
